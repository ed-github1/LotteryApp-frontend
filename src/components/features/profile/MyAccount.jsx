      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="mt-8 w-full px-6 py-3 bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-xl font-bold shadow-lg hover:shadow-pink-500/30 transition-all duration-300 flex items-center justify-center gap-2"
          >
