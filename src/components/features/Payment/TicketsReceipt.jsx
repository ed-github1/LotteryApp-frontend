...
const TicketsReceipt = ({ tickets, date, receiptNumber, customerId }) => {
    ...
    return (
        <div className="bg-white w-full text-black shadow-xl border border-gray-200 font-mono text-sm">
            {/* Receipt Header */}
            <div className="bg-gray-800 text-white text-center py-3 px-4">
                <div className="font-bold text-lg">LOTTERY RECEIPT</div>
                <div className="text-xs opacity-75">International Lottery Service</div>
            </div>
